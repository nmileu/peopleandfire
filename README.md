...
This project aims at refocusing the wildfire problem by assuming that many of those practices are rational within the current policy and socioeconomic setting. 
