function simula1() {
			...
			console.log(agricultura2otherUso);
				if (agricultura2otherUso === "2")
				{
					...
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA - agriculturaValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA + agriculturaValor;
				...
				if (agricultura2otherUso === "3")
				{
					...
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA - agriculturaValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;
					var EUCALIPTO_NEW = layer.feature.properties.FOLHOSAS_HA + agriculturaValor;
				...
				if (agricultura2otherUso === "4")
				{
					...
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA - agriculturaValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA + agriculturaValor;
				...
				if (agricultura2otherUso === "5")
				{
					...
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA - agriculturaValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA + agriculturaValor;
				...
				if (agricultura2otherUso === "6")
				{
					...
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA - agriculturaValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA + agriculturaValor;
				...
				if (agricultura2otherUso === "7")
				{
					...
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA - agriculturaValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;
					var MATOS_NEW = layer.feature.properties.MATOS_HA + agriculturaValor;
				...
				if (agricultura2otherUso === "8")
				{
					...
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA - agriculturaValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA + agriculturaValor;
			...
			freguesiaselLayer.eachLayer(function(layer) {  // eachLayer() is an Leaflet function to iterate over the layers/points of the map					
				...
				var LR_TOTAL = LR_COS + LR_SLOPE + LR_ELEVATION;
			...
			layerGroup.addLayer(freguesiaselLayer);
			//layerGroup.removeLayer(freguesiaselLayer);
...
function simula2() {
			...
			console.log(folhosas2otherUso);
				if (folhosas2otherUso === "1")
				{
					...
					freguesiaselLayer.eachLayer(function(layer) {  // eachLayer() is an Leaflet function to iterate over the layers/points of the map
					//console.log(layer.feature.properties.AGRICULTURA_HA);
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA - folhosasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA + folhosasValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;					
					});
				}
				if (folhosas2otherUso === "3")
				{
					...
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA - folhosasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA + folhosasValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					});					
				}
				if (folhosas2otherUso === "4")
				{
					...
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA - folhosasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA + folhosasValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					});
				}
				if (folhosas2otherUso === "5")
				{
					...
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA - folhosasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA + folhosasValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					});
				}
				if (folhosas2otherUso === "6")
				{
					...
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA - folhosasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA + folhosasValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					});
				}
				if (folhosas2otherUso === "7")
				{
					...
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA - folhosasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					var MATOS_NEW = layer.feature.properties.MATOS_HA + folhosasValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					});
				}
				if (folhosas2otherUso === "8")
				{
					...
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA - folhosasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA + folhosasValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					});
				}
			//CÁLCULO DA FRAÇÃO DA ÁREA_HA
...
function simula3() {
			...
			console.log(eucalipto2otherUso);
				if (eucalipto2otherUso === "1")
				{
					...
					freguesiaselLayer.eachLayer(function(layer) {  // eachLayer() is an Leaflet function to iterate over the layers/points of the map
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA - eucaliptoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA + eucaliptoValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;					
					});
				}
				if (eucalipto2otherUso === "2")
				{
					...
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA - eucaliptoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA + eucaliptoValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					});					
				}
				if (eucalipto2otherUso === "4")
				{
					...
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA - eucaliptoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA + eucaliptoValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					});
				}
				if (eucalipto2otherUso === "5")
				{
					...
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA - eucaliptoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA + eucaliptoValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					});
				}
				if (eucalipto2otherUso === "6")
				{
					...
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA - eucaliptoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA + eucaliptoValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					});
				}
				if (eucalipto2otherUso === "7")
				{
					...
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA - eucaliptoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					var MATOS_NEW = layer.feature.properties.MATOS_HA + eucaliptoValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					});
				}
				if (eucalipto2otherUso === "8")
				{
					...
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA - eucaliptoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA + eucaliptoValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					});
				}
			//CÁLCULO DA FRAÇÃO DA ÁREA_HA
...
function simula4() {
			...
			console.log(invasoras2otherUso);
				...
				if (invasoras2otherUso === "2")
				{
					...
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA - invasorasValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA + invasorasValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					});					
				}
				if (invasoras2otherUso === "3")
				{
					...
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA - invasorasValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA + invasorasValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					});
				}
				if (invasoras2otherUso === "5")
				{
					...
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA - invasorasValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA + invasorasValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					});
				}
				if (invasoras2otherUso === "6")
				{
					...
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA - invasorasValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA + invasorasValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					});
				}
				if (invasoras2otherUso === "7")
				{
					...
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA - invasorasValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					var MATOS_NEW = layer.feature.properties.MATOS_HA + invasorasValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					});
				}
				if (invasoras2otherUso === "8")
				{
					...
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA - invasorasValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA + invasorasValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					});
				}
			//CÁLCULO DA FRAÇÃO DA ÁREA_HA
...
function simula5() {
			...
			console.log(pinheirobravo2otherUso);
				...
				if (pinheirobravo2otherUso === "2")
				{
					...
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA - pinheirobravoValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA + pinheirobravoValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					});					
				}
				if (pinheirobravo2otherUso === "3")
				{
					...
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA - pinheirobravoValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA + pinheirobravoValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					});
				}
				if (pinheirobravo2otherUso === "4")
				{
					...
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA - pinheirobravoValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA + pinheirobravoValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					});
				}
				if (pinheirobravo2otherUso === "6")
				{
					...
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA - pinheirobravoValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA + pinheirobravoValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					});
				}
				if (pinheirobravo2otherUso === "7")
				{
					...
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA - pinheirobravoValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					var MATOS_NEW = layer.feature.properties.MATOS_HA + pinheirobravoValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					});
				}
				if (pinheirobravo2otherUso === "8")
				{
					...
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA - pinheirobravoValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA + pinheirobravoValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					});
				}
			//CÁLCULO DA FRAÇÃO DA ÁREA_HA
...
function simula6() {
			...
			console.log(outrospinheiros2otherUso);
				if (outrospinheiros2otherUso === "1")
				{
					...
					freguesiaselLayer.eachLayer(function(layer) {  // eachLayer() is an Leaflet function to iterate over the layers/points of the map
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA - outrospinheirosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA + outrospinheirosValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;					
					});
				}
				if (outrospinheiros2otherUso === "2")
				{
					...
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA - outrospinheirosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA + outrospinheirosValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					});					
				}
				if (outrospinheiros2otherUso === "3")
				{
					...
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA - outrospinheirosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA + outrospinheirosValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					});
				}
				if (outrospinheiros2otherUso === "4")
				{
					...
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA - outrospinheirosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA + outrospinheirosValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					});
				}
				if (outrospinheiros2otherUso === "5")
				{
					...
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA - outrospinheirosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA + outrospinheirosValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					});
				}
				if (outrospinheiros2otherUso === "7")
				{
					...
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA - outrospinheirosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					var MATOS_NEW = layer.feature.properties.MATOS_HA + outrospinheirosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					});
				}
				if (outrospinheiros2otherUso === "8")
				{
					...
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA - outrospinheirosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA + outrospinheirosValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					});
				}
			//CÁLCULO DA FRAÇÃO DA ÁREA_HA
...
function simula7() {
			...
			console.log(matos2otherUso);
				if (matos2otherUso === "1")
				{
					...
					freguesiaselLayer.eachLayer(function(layer) {  // eachLayer() is an Leaflet function to iterate over the layers/points of the map
					var MATOS_NEW = layer.feature.properties.MATOS_HA - matosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA + matosValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;					
					});
				}
				if (matos2otherUso === "2")
				{
					...
					var MATOS_NEW = layer.feature.properties.MATOS_HA - matosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA + matosValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					});					
				}
				if (matos2otherUso === "3")
				{
					...
					var MATOS_NEW = layer.feature.properties.MATOS_HA - matosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA + matosValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					});
				}
				if (matos2otherUso === "4")
				{
					...
					var MATOS_NEW = layer.feature.properties.MATOS_HA - matosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA + matosValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					});
				}
				if (matos2otherUso === "5")
				{
					...
					var MATOS_NEW = layer.feature.properties.MATOS_HA - matosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA + matosValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					});
				}
				if (matos2otherUso === "6")
				{
					...
					var MATOS_NEW = layer.feature.properties.MATOS_HA - matosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA + matosValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					});
				}
				if (matos2otherUso === "8")
				{
					...
					var MATOS_NEW = layer.feature.properties.MATOS_HA - matosValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA + matosValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					});
				}
			//CÁLCULO DA FRAÇÃO DA ÁREA_HA
...
function simula8() {
			...
			console.log(naocombustivel2otherUso);
				if (naocombustivel2otherUso === "1")
				{
					...
					freguesiaselLayer.eachLayer(function(layer) {  // eachLayer() is an Leaflet function to iterate over the layers/points of the map
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA - naocombustivelValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					var AGRICULTURA_NEW = layer.feature.properties.AGRICULTURA_HA + naocombustivelValor;
					layer.feature.properties.AGRICULTURA_HA = AGRICULTURA_NEW;					
					});
				}
				if (naocombustivel2otherUso === "2")
				{
					...
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA - naocombustivelValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					var FOLHOSAS_NEW = layer.feature.properties.FOLHOSAS_HA + naocombustivelValor;
					layer.feature.properties.FOLHOSAS_HA = FOLHOSAS_NEW;
					});					
				}
				if (naocombustivel2otherUso === "3")
				{
					...
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA - naocombustivelValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					var EUCALIPTO_NEW = layer.feature.properties.EUCALIPTO_HA + naocombustivelValor;
					layer.feature.properties.EUCALIPTO_HA = EUCALIPTO_NEW;
					});
				}
				if (naocombustivel2otherUso === "4")
				{
					...
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA - naocombustivelValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					var INVASORAS_NEW = layer.feature.properties.INVASORAS_HA + naocombustivelValor;
					layer.feature.properties.INVASORAS_HA = INVASORAS_NEW;
					});
				}
				if (naocombustivel2otherUso === "5")
				{
					...
					var NAOCOMBUSTIVEL_NEW = layer.feature.properties.NAOCOMBUSTIVEL_HA - naocombustivelValor;
					layer.feature.properties.NAOCOMBUSTIVEL_HA = NAOCOMBUSTIVEL_NEW;
					var PINHEIROBRAVO_NEW = layer.feature.properties.PINHEIRO_BRAVO_HA + naocombustivelValor;
					layer.feature.properties.PINHEIRO_BRAVO_HA = PINHEIROBRAVO_NEW;
					});
				}
				if (naocombustivel2otherUso === "6")
				{
					alert("Transferência do uso para " + naocombustivel2otherUso);
					freguesiaselLayer.eachLayer(function(layer) {  // eachLayer() is an Leaflet function to iterate over the layers/points of the map
					var MATOS_NEW = layer.feature.properties.MATOS_HA - naocombustivelValor;
					layer.feature.properties.MATOS_HA = MATOS_NEW;
					var OUTROSPINHEIROS_NEW = layer.feature.properties.OUTROS_PINHEIROS_HA + naocombustivelValor;
					layer.feature.properties.OUTROS_PINHEIROS_HA = OUTROSPINHEIROS_NEW;
					});
				}
